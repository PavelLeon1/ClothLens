...
- гибридный режим проверяет качество U-Net-маски и откатывается на SegFormer,
  если выбранный класс не найден или занимает слишком маленькую область;
...
- он служит практическим fallback, когда U-Net ошибается на конкретном фото;
